...
il risultato che ci viene tramite postman è un oggetto con 100 value al suo interno, tra "id", "title", "date" e "url".
per questo esercizio useremo url per ottenere delle immagine da questa api da mettere all'interno del container.
inoltre creiamo tutti e 6 i container attraverso javascript
